<div class="sidebar col-sm-3 col-md-2" ng-controller="SidebarCtrl">
  ...
  <div class="sidebar-title relative">
    ...
    <li class="sidebar__menu_dropdown">
      <button ng-if="hasAccess('dashboard')" type="button" class="sidebar-menu_button btn btn-black {{isCurrentPath.indexOf('dashboard')>-1 ? 'active' : '' }}" ng-click="go('/dashboard')"><span class="glyphicon glyphicon-dashboard small-margin-right" aria-hidden="true"></span> Dashboard <span class="sr-only">(current)</span></button>
      ...
      <div uib-collapse="{{isCurrentPath.indexOf('page')>-1 ? '' : 'isCollapsedMain' }}" >
        <ul class="sidebar__main-menu_button_list">
          <li ng-if="hasAccess('page-1')" class="{{isCurrentPath.indexOf('page-1')>-1 ? 'selected' : '' }}" ng-click="go('/page-1')"><a ng-href="/#!/page-1"><span class="glyphicon glyphicon-dashboard small-margin-right" aria-hidden="true"></span> Page 1</a></li>
          <li ng-if="hasAccess('page-2')" class="{{isCurrentPath.indexOf('page-2')>-1 ? 'selected' : '' }}" ng-click="go('/page-2')"><a ng-href="/#!/page-2"><span class="glyphicon glyphicon-dashboard small-margin-right" aria-hidden="true"></span> Page 2</a></li>
          <li ng-if="hasAccess('page-3')" class="{{isCurrentPath.indexOf('page-3')>-1 ? 'selected' : '' }}" ng-click="go('/page-3')"><a ng-href="/#!/page-3"><span class="glyphicon glyphicon-dashboard small-margin-right" aria-hidden="true"></span> Page 3</a></li>
          <li ng-if="hasAccess('page-4')" class="{{isCurrentPath.indexOf('page-4')>-1 ? 'selected' : '' }}" ng-click="go('/page-4')"><a ng-href="/#!/page-4"><span class="glyphicon glyphicon-dashboard small-margin-right" aria-hidden="true"></span> Page 4</a></li>
        </ul>
      </div>
    </li> 
	</ul>
  ...
  <ul class="sidebar__settings-menu nav sidebar-nav" ng-show="!menuToggle">
    <li class="sidebar__menu_dropdown">
      <button ng-if="hasAccess('profile')" type="button" class="{{isCurrentPath.indexOf('profile')>-1 ? 'selected-config' : '' }} sidebar-menu_button btn btn-black" ng-click="go('/profile')"><span class="glyphicon glyphicon-user small-margin-right" aria-hidden="true"></span> My Profile <span class="sr-only">(current)</span></button>
      <button ng-if="hasAccess('users')" type="button" class="{{(isCurrentPath.indexOf('users')>-1 || isCurrentPath.indexOf('User')>-1) ? 'selected-config' : '' }} sidebar-menu_button btn btn-black" ng-click="go('/users')"><span class="glyphicon glyphicon-th-list small-margin-right" aria-hidden="true"></span> Users <span class="sr-only">(current)</span></button>
      ...
      <div uib-collapse="{{(isCurrentPath.indexOf('accessLevels')>-1 || isCurrentPath.indexOf('pageAccess')>-1) ? '' : 'isCollapsedAccess' }}" >
        <ul class="sidebar__settings-menu_button_list" role="menu">
          <li ng-if="hasAccess('accessLevels')" class="{{isCurrentPath.indexOf('accessLevels')>-1 ? 'selected-config' : '' }} padding-left" ng-click="go('/accessLevels')"><a ng-href="/#!/accessLevels"><span style="font-size:0.8em;" class="glyphicon glyphicon-triangle-right small-margin-right" aria-hidden="true"></span>Access Levels</a></li>
          <li ng-if="hasAccess('pageAccess')" class="{{isCurrentPath.indexOf('pageAccess')>-1 ? 'selected-config' : '' }} padding-left" ng-click="go('/pageAccess')"><a ng-href="/#!/pageAccess"><span style="font-size:0.8em;" class="glyphicon glyphicon-triangle-right small-margin-right" aria-hidden="true"></span>Page Access</a></li>
        </ul>
      </div>
