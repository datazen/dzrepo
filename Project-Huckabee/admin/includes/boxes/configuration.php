...
$heading[] = array('text'  => BOX_HEADING_CONFIGURATION,
  ...
  while ($configuration_groups = tep_db_fetch_array($configuration_groups_query)) {
    $cfg_groups .=  tep_admin_files_boxes(FILENAME_CONFIGURATION,  $configuration_groups['cgTitle'], 'NONSSL', 'gID=' . $configuration_groups['cgID'] . 'gID=1&selected_box=configuration&section=config_' . $configuration_groups['cgID'],'2');
  }
