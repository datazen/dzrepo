            ...
            <div class="well">
                <form name="form" ng-submit="vm.updateProfile()" role="form">
                    ...
                    <div class="form-group" ng-class="{ 'has-error' : form.password.$dirty && form.password.$invalid }">
                        ...
                        <input type="password" class="form-control" id="password" name="password" ng-model="vm.user.password" password-verify="{{vm.user.confirmPassword}}" />
                    ...
                    <div class="form-group" ng-class="{ 'has-error' : form.confirmPassword.$dirty && form.confirmPassword.$invalid }">
                        ...
                        <input class="form-control" id="confirmPassword" ng-model="vm.user.confirmPassword" name="confirmPassword" type="password" password-verify="{{vm.user.password}}" />
                    ...
                    <div class="form-actions align-right">
                        <a ng-href="#!/Admin/dashboard" class="btn btn-link">Cancel</a>
