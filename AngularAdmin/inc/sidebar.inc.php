<div class="sidebar col-sm-3 col-md-2" ng-controller="SidebarCtrl">
  ...
  <ul class="sidebar__settings-menu nav sidebar-nav" ng-show="!menuToggle">
    <li class="sidebar__menu_dropdown">
      ...
      <div uib-collapse="{{(isCurrentPath.indexOf('accessLevels')>-1 || isCurrentPath.indexOf('pageAccess')>-1) ? '' : 'isCollapsedConfig' }}" >
        <ul class="sidebar__main-menu_button_list" role="menu">
          <li class="{{isCurrentPath.indexOf('accessLevels')>-1 ? 'selected' : '' }}" ng-click="go('/accessLevels')"><a ng-href="/#!/accessLevels"><span class="glyphicon glyphicon-lock small-margin-right" aria-hidden="true"></span> Access Levels</a></li>
          <li class="{{isCurrentPath.indexOf('pageAccess')>-1 ? 'selected' : '' }}" ng-click="go('/pageAccess')"><a ng-href="/#!/pageAccess"><span class="glyphicon glyphicon-file small-margin-right" aria-hidden="true"></span> Page Access</a></li>
        </ul>
      </div>
    </li> 
  </ul>  
